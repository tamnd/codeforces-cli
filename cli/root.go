// Package cli builds the cf command tree on top of the codeforces library.
package cli
...
func Root() *cobra.Command {
	app := &App{cfg: codeforces.DefaultConfig()}

	root := &cobra.Command{
		Use:   "cf",
		Short: "Browse Codeforces competitive programming problems",
		Long: `cf reads Codeforces through its official public JSON API.
No API key is required. It returns records as table, JSON, JSONL, CSV, TSV,
or URLs.

cf is an independent tool and is not affiliated with Codeforces or Codeforces LLC.`,
		SilenceUsage:  true,
		SilenceErrors: true,
...
func (a *App) setup() error {
	...
	a.client = codeforces.NewClient(a.cfg)
	return nil
}
