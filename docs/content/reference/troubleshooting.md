...
Most of these come down to network reality or how codeforces serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

codeforces rate-limits like any public site. cf already paces
...
Where a surface is gated, cf reads a cookie or token you supply
...
`cf`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what cf actually did
